...
[FileName,PathName] = uigetfile([projectDir,filesep,'*.txt'],'Raw input file');
...
if(resets > 0)
    reset_times = datestr(time(reset))
end
...
g = fopen('rgbcalibrationvalues.txt');
