function PhasorReport(stime,sCS,sAI,time,CS,AI,Title)
%PHASORREPORT Generates graphical summary of CS and Activity

% Process and analyze data
% Trim data to length of experiment
TI = stime - stime(1); % time index in days from start
days = floor(max(TI));
...
hold(gca);
phasorplot(sMagnitude,sAngle,.75,3,6,'top','left',.1,0,0,'r');
